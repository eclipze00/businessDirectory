...
export default function addBusiness() {
  ...
  useEffect(()=>{
    ...
    getCategoryList(); // Será chamado apenas uma vez
  ...
  return (
    <View style={{
      ...
      {/* Se a function estiver sem imagem, vai aparecer o placeholder, se tiver colocado imagem, vai aparecer a imagem selecionada */}
